...
public class PathsDAO
{
	 ...
	 * It is an infinite recursive loop stopping if connSet1 and connSet2 has intersection, or all links where scanned.
	 */
	...
	/*
	 * Returns Set of next layer of neighbor nodes.
	 */
	...
	/*
	 * Reading data from text file and map it in cities and connectionMap data structures. 
	 */
